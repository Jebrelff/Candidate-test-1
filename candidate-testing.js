...
function gradeQuiz(candidateAnswers) {
  ...
  let correct = 0; // numbers of questions answered correctly
  for(let i = 0; i < questions.length; i++) {
  ...
  let grade = (correct / questions.length) * 100;  // TODO 3.2 use this variable to calculate the candidate's score.
